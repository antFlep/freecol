...
public class ContinueMessage extends TrivialMessage {
    ...
    public static final String TAG = "continue";


    /**
     * Create a new {@code ContinueMessage} of a given type.
     */
    ...
    /**
     * Create a new {@code ContinueMessage} from a stream.
     *
     ...
     */
    public ContinueMessage(Game game, FreeColXMLReader xr)
