...
public class RequestLaunchMessage extends TrivialMessage {
    ...
    public static final String TAG = "requestLaunch";
    

    /**
     * Create a new {@code RequestLaunchMessage}.
     */
    ...
    /**
     * Create a new {@code RequestLaunchMessage} from a stream.
     *
     ...
     */
    public RequestLaunchMessage(Game game, FreeColXMLReader xr)
