 ...
 */
public class RetireMessage extends TrivialMessage {

    public static final String TAG = "retire";
    

    /**
     * Create a new {@code RetireMessage}.
     */
    public RetireMessage() {
        super(TAG);
    }

    /**
     * Create a new {@code RetireMessage} from a stream.
     *
